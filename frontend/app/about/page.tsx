...
import { Users, Building2, TrendingUp, Target, Lightbulb, CheckCircle2, Headset, Zap, ShieldCheck, Map, LayoutDashboard, DollarSign } from "lucide-react";
      ...
      <section className="py-24 bg-white relative">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             {[
               { icon: Headset, title: "24/7 Property Support", desc: "Our dedicated team is always available to handle tenant emergencies and maintenance requests." },
               { icon: Zap, title: "Fast Tenant Placement", desc: "We aggressively market your property to quickly secure reliable, thoroughly-vetted tenants." },
               { icon: ShieldCheck, title: "Secure Transactions", desc: "Bank-grade encryption ensures all your rent payments, deposits, and financial data stay protected." },
               { icon: Map, title: "Deep Local Expertise", desc: "With extensive roots in Mogadishu, we understand the local real estate market meticulously." },
               { icon: LayoutDashboard, title: "Smart Landlord Portal", desc: "Access your centralized dashboard to monitor rent, occupancy rates, and repair statuses." },
               { icon: DollarSign, title: "Transparent Pricing", desc: "No hidden fees. Experience full financial clarity with our competitive and straightforward rates." }
             ].map((feature, i) => (
